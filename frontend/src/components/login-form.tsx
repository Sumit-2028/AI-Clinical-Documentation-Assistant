  ...
  return <div className="auth-form-wrap">
    <div className="auth-card">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button className="auth-submit" type="submit">Login <span>→</span></button>
        {submitted && <p className="auth-status" role="status">Authentication is ready to connect to your existing sign-in service.</p>}
      </form>
