...
export type ThreadMatchConfidence = 'high' | 'low'
...
export interface ConflictResolutionResponse { conflict_id: string; status: 'resolved' | 'dismissed'; new_event_id: string | null }
